...
<div class="portfolio-item columns-count-<?php echo $columns; ?> <?php echo $span; ?> <?php echo $catsClass; ?>">       
		<?php if (has_post_thumbnail( $postId ) ): ?>
			<div class="portfolio-image">
					...
					<div class="zoom">
						<div class="btn_group">
							<?php if($lightbox): ?><a href="<?php echo etheme_get_image(get_post_thumbnail_id($postId)); ?>" class="btn btn-black xmedium-btn" rel="lightbox"><span><?php _e('Ver en grande', ETHEME_DOMAIN); ?></span></a><?php endif; ?>
