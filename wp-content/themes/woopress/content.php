...
*/
    ...
    $post_content = get_the_content('<span class="btn big filled pull-right read-more">'.__('Leer Más', ETHEME_DOMAIN).'</span>');
...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
	<div>
		<?php if($post_format == 'quote' || $post_format == 'video'): ?>
	            ...
	            <?php the_content('<span class="btn big filled pull-right read-more">'.__('Leer Más', ETHEME_DOMAIN).'</span>'); ?>
		...
		<?php elseif(has_post_thumbnail()): ?>
			<div class="wp-picture">
				...
				<div class="zoom">
					<div class="btn_group">
						<a href="<?php echo etheme_get_image(); ?>" class="btn btn-black xmedium-btn" rel="pphoto"><span><?php _e('Ver en grande', ETHEME_DOMAIN); ?></span></a>
						<a href="<?php the_permalink(); ?>" class="btn btn-black xmedium-btn"><span><?php _e('Más detalles', ETHEME_DOMAIN); ?></span></a>
					</div>
					<i class="bg"></i>
				</div>
			</div>
		...
		<?php if($post_format != 'quote'): ?>
	        ...
	        <?php if(etheme_get_option('blog_byline') && etheme_get_option('blog_layout') != 'timeline'): ?>
	            <div class="meta-post">
	                    ...
	                    <?php _e('por', ETHEME_DOMAIN);?> <?php the_author_posts_link(); ?>
	        ...
	        <?php elseif(etheme_get_option('blog_byline') && etheme_get_option('blog_layout') == 'timeline'): ?>
	            <div class="meta-post">
	                    <?php _e('Escrito por', ETHEME_DOMAIN);?> <?php the_author_posts_link(); ?>
	                    <?php // Display Comments 
