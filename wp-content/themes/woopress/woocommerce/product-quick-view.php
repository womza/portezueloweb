            ...
            <div class="row">
                ...
                <div class="col-lg-<?php if (etheme_get_option('quick_images') != 'none'): ?>6<?php else: ?>12<?php endif; ?> col-sm-6 product-information">
                    <div class="product-navigation clearfix">
						<h4 class="zlarge-h meta-title"><span><?php _e('Descripción del Producto', ETHEME_DOMAIN); ?></span></h4>
					</div>
					...
					<?php if (etheme_get_option('product_link')): ?>
			        	<a href="<?php the_permalink(); ?>" class="show-full-details"><?php _e('Mostrar todos los detalles', ETHEME_DOMAIN); ?></a>
					<?php endif; ?>
