<?php 
	...
	if(have_comments()) :?>
		...
		<h4 class="title-alt"><span><?php comments_number(__('Ningún comentario', ETHEME_DOMAIN), __('Un comentario', ETHEME_DOMAIN), __('% comentarios', ETHEME_DOMAIN)); ?></span></h4>
	...
	comment_form(array('title_reply' => '<span>' . __('Deja tu comentario', ETHEME_DOMAIN) . '</span>'));
?>