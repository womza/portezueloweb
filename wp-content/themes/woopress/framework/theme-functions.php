...
?>
            ...
            <script type="text/javascript">
                ...
                var successfullyAdded = '<?php echo esc_js(__('Producto añadido con éxito a tu Carrito',ETHEME_DOMAIN)); ?>';
                ...
                <?php if (class_exists('WooCommerce')) {
                    ...
                    ?>
                        ...
                        var contBtn = '<?php echo esc_js(__('Seguir comprando', ETHEME_DOMAIN)); ?>';
                        var checkBtn = '<?php echo esc_js(__('Completar compra', ETHEME_DOMAIN)); ?>';
                    <?php
                } ?>
            ...
            <div class="header-search ">
                <?php if($search_view == 'modal'): ?>
                    <div class="et-search-trigger">
                        <a class="popup-with-form" href="#searchModal"><i class="fa fa-search"></i> <span><?php _e('Buscar', ETHEME_DOMAIN); ?></span></a>
                    </div>
                <?php else : ?>
        ...
        ?>
            <div id="searchModal" class="mfp-hide modal-type-1 zoom-anim-dialog" role="search">
                <div class="modal-dialog text-center">
                    <h3 class="large-h"><?php _e('Motor de búsqueda', ETHEME_DOMAIN); ?></h3>
                    <small class="mini-text"><?php _e('Utiliza este formulario para encontrar lo que estás buscando en el sitio', ETHEME_DOMAIN); ?></small>
            ...
            <li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
                <div class="media">
                    ...
                    <?php if ($comment->comment_approved == '0'): ?>
                        <p class="awaiting-moderation"><?php __('Tu comentario debe ser aprobado por el moderador.', ETHEME_DOMAIN) ?></p>
                    <?php endif ?>
                    
                    <?php comment_text(); ?>
                    <?php comment_reply_link(array_merge($args, array('reply_text' => __('Responder el comentario', ETHEME_DOMAIN),'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>
...
if(!function_exists('etheme_custom_comment_form')) {
    function etheme_custom_comment_form($defaults) {
        ...
        $defaults['comment_field'] = '<div class="form-group"><label for="comment" class="control-label">'.__('Comentario', ETHEME_DOMAIN).'</label><textarea class="form-control required-field"  id="comment" name="comment" cols="45" rows="12" aria-required="true"></textarea></div>';
    ...
    function etheme_custom_comment_form_fields() {
        ...
        $fields = array(
            'author' => '<div class="form-group comment-form-author">'.
                            '<label for="author" class="control-label">'.__('Nombre', ETHEME_DOMAIN).' '.($req ? $reqT : '').'</label>'.
            ...
            'url' => '<div class="form-group comment-form-url">'.
                            '<label for="url" class="control-label">'.__('Teléfono / Celular', ETHEME_DOMAIN).'</label>'.
...
if(!function_exists('et_back_to_page')) {
    function et_back_to_page() {
        echo '<a class="back-history" href="javascript: history.go(-1)">'.__('Volver a la página anterior',ETHEME_DOMAIN).'</a>';
    }
}
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="about-company">
                                <a class="pull-left" href="#"><img title="WooPressStore" src="<?php echo PARENT_URL.'/images/logo_2.png'; ?>" alt="..."><br></a>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consect etur adipisic ing elit, sed.</p>
                            <address class="address-company"><br>
                                ...
                                <a class="white-text letter-offset" href="#">www.8theme.com</a><br>
...
if(!function_exists('et_get_related_posts')) {
    function et_get_related_posts($postId = false, $limit = 5){
        ...
        if ($categories) {
            ...
            etheme_create_posts_slider($args, __('Entradas relacionadas', ETHEME_DOMAIN), false, true, true);
        }
    }
}
        ...
        ?>
            <div id="etheme-popup" class="white-popup-block mfp-hide mfp-with-anim zoom-anim-dialog">
                ...
                <p class="checkbox-label">
                    ...
                    <label for="showagain"><?php _e("No mostrar este anuncio de nuevo", ETHEME_DOMAIN); ?></label>
                </p>
            </div>
            <style type="text/css">
                #etheme-popup {
