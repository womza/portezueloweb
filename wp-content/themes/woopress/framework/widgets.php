...
?>
        ...
        <?php etheme_widget_input_checkbox(__('Buscar por entradas', ETHEME_DOMAIN), $this->get_field_id('posts'), $this->get_field_name('posts'),checked($posts, true, false), 1); ?>
        <?php etheme_widget_input_checkbox(__('Search for portfolio', ETHEME_DOMAIN), $this->get_field_id('portfolio'), $this->get_field_name('portfolio'),checked($portfolio, true, false), 1); ?>
...
class Etheme_QRCode_Widget extends WP_Widget {
    ...
    function Etheme_QRCode_Widget() {
        ...
        $this->WP_Widget('etheme-qr-code', '8theme - '.__('Código QR', ETHEME_DOMAIN), $widget_ops);
...
class Etheme_Recent_Comments_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('etheme-recent-comments', '8theme - '.__('Comentarios recientes', ETHEME_DOMAIN), $widget_ops);
